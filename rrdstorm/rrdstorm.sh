...
# 2 - Disk temperature,
# 3 - CPU usage,
# 4 - Ethernet traffic statistics,
# 5 - Disk space,
# 6 - (TO DO!) Disk start\stop count.
#
####################################################################
...
RRDcFILE[2]="temp:60:Disk temperature graphs"
RRDcDEF[2]='
...
RRDgGRAPH[12]='3600|temp1|Disk temperature, last hour|[ "$M" = 30 ]|-l 0 -r'
RRDgGRAPH[13]='14400|temp6|Disk temperature, last 4 hours|[ "$M" = 30 ]|-l 0 -r'
RRDgGRAPH[14]='86400|temp24|Disk temperature, last day|[ "$H" = 04 ] && [ "$M" = 30 ]|-l 0 -r --x-grid HOUR:1:DAY:1:HOUR:1:0:%H'
RRDgGRAPH[15]='604800|tempW|Disk temperature, last week|[ "$H" = 04 ] && [ "$M" = 30 ]|-l 0 -r --x-grid HOUR:4:DAY:1:DAY:1:0:"%a %d/%m"'
RRDgGRAPH[16]='2678400|tempM|Disk temperature, last month|[ "$H" = 04 ] && [ "$M" = 30 ]|-l 0 -r'
RRDgGRAPH[17]='31536000|tempY|Disk temperature, last year|[ "$H" = 04 ] && [ "$M" = 30 ]|-l 0 -r'
...
RRDcFILE[4]="wan:60:Ethernet Traffic graphs"
RRDcDEF[4]='
...
RRDgGRAPH[24]='3600|wan1|Ethernet Traffic, last hour|[ "$M" = 30 ]|-r'
RRDgGRAPH[25]='14400|wan6|Ethernet Traffic, last 4 hours|[ "$M" = 30 ]|-r'
RRDgGRAPH[26]='86400|wan24|Ethernet Traffic, last day|[ "$M" -ge 30 ] && [ "$M" -le 45 ]|-r --x-grid HOUR:1:DAY:1:HOUR:1:0:%H'
RRDgGRAPH[27]='604800|wanW|Ethernet Traffic, last week|[ "$M" -ge 30 ] && [ "$M" -le 45 ]|-r --x-grid HOUR:4:DAY:1:DAY:1:0:"%a %d/%m"'
RRDgGRAPH[28]='2678400|wanM|Ethernet Traffic, last month|[ "$H" = 04 ] && [ "$M" -ge 30 ] && [ "$M" -le 45 ]|-r '
RRDgGRAPH[29]='31536000|wanY|Ethernet Traffic, last year|[ "$H" = 04 ] && [ "$M" -ge 30 ] && [ "$M" -le 45 ]|-r '
...
'AREA:bo#DDDDDD:'
'AREA:mntzasede#CC0033:DataVolume:'
...
'AREA:mntprosto#EC2053:Free:STACK'
  ...
  GPRINT:procar:"%6.2lf%%\n"
'AREA:optzasede#33CC00:rootfs    :STACK'
...
#-------------------------------------------------------------------
# data definition: Disk start\stop count
#-------------------------------------------------------------------

RRDcFILE[6]="wlan:60:Disk start\stop count"
RRDcDEF[6]='
